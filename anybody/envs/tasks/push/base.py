...
def get_base_env(robo_type, robo_name, n_obs, n_blocks, seed=0, version_name='v1'):
    np.random.seed(seed)
    random.seed(seed)
...
def get_v1_env(robo_type, robo_name, seed=0):
    return get_base_env(robo_type, robo_name, n_obs=0, n_blocks=1, seed=seed, version_name='v1')


def get_v2_env(robo_type, robo_name, seed=0):
    n_blocks = np.random.randint(1, 5)
    return get_base_env(robo_type, robo_name, n_obs=0, n_blocks=n_blocks, seed=seed, version_name='v2')


def get_v3_env(robo_type, robo_name, seed=0):
    n_blocks = np.random.randint(1, 5)
    n_obs = np.random.randint(1, 10 - n_blocks)
    return get_base_env(robo_type, robo_name, n_obs=n_obs, n_blocks=n_blocks, seed=seed, version_name='v3')
