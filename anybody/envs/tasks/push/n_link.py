...
#     found = False
#     all_obs["ground"] = eu.add_ground_prim(
    ...
    for _ in range(max_tries):
        ...
        for idx in range(n_blocks):
            for _ in range(100):
                ...
                p[:3, 3] = [r * np.cos(theta), r * np.sin(theta), pz]
...
def get_v1_env(robo_type, robo_fname, seed=0):
    return get_base_env(robo_type, robo_fname, n_obs=0, n_blocks=1, seed=seed, version_name="v1")


def get_v2_env(robo_type, robo_fname, seed=0):
    return get_base_env(robo_type, robo_fname, n_obs=0, n_blocks=2, seed=seed, version_name="v2")


def get_v3_env(robo_type, robo_fname, seed=0):
    return get_base_env(robo_type, robo_fname, n_obs=1, n_blocks=1, seed=seed, version_name="v3")


def get_v4_env(robo_type, robo_fname, seed=0):
    n_obs = np.random.randint(2, 5)
    return get_base_env(robo_type, robo_fname, n_obs=n_obs, n_blocks=1, seed=seed, version_name="v4")
