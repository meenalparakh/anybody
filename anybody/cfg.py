...
_C.OBSERVATION.RANDOMIZE_ROBOT_MATERIAL = False
...
_C.REWARD.JOINT_LIMITS_WEIGHT = 0.1
_C.REWARD.JOINT_ACC_WEIGHT = 0.001
...
_C.TRAIN.EPISODE_LENGTH_S = 3.0
_C.TRAIN.DECIMATION = 2
_C.TRAIN.SIM_DT = 1 / 120
# _C.TRAIN.EPISODE_LENGTH_S = 20.0
# _C.TRAIN.DECIMATION = 2
# _C.TRAIN.SIM_DT = 0.005

_C.EVAL_EPISODE_LENGTH_S = 3.0
...
_C.AGENT.EXPERIMENT.WANDB_KWARGS.GROUP = None  # to be set by the train script
