...
ISAACLAB_DIR = os.path.join(PROJECT_DIR, "isaaclab")
...
try:
    ...
    isaacsim_dir = os.path.join(PROJECT_DIR, "_isaac_sim")
except EOFError:
...
def overwrite_python_analysis_extra_paths(isaaclab_settings: str) -> str:
    ...
    path_names.extend(['"${workspaceFolder}/isaaclab/source/' + ext + '"' for ext in isaaclab_extensions])
